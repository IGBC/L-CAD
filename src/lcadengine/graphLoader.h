...
/**
 * @brief Creates a graph from the contents of the specified file.
 *
 * Creates a new logicGraph from the contents of a graph description file.
 *
 * @param char *filename path and name of the file to load from.
 *
 * @return logicGraph Graph described by the input string.
 * 					  NULL on error.
 */
